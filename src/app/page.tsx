        ...
        <section id="projects" className="container mx-auto space-y-6 py-8 md:py-12 lg:py-24">
          ...
          <div className="mx-auto grid justify-center gap-6 sm:grid-cols-1 md:max-w-[64rem] md:grid-cols-2 lg:grid-cols-3">
            <ProjectCardSiak
              ...
              imageUrl="/portofolio/moha.svg?height=300&width=400" // Update the path here
            ...
            <ProjectCardIkd
              ...
              imageUrl="/portofolio/moha.svg?height=300&width=400"
            ...
            <ProjectCardEst
              ...
              imageUrl="/portofolio/next.svg?height=300&width=400"
